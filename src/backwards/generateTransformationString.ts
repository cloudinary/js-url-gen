...
import {LegacyITransforamtionOptions, LegacyTransformation} from "../types/types.js";
...
export const transformationStringFromObject: (transformationOptions: LegacyTransformation) => string = generateTransformationString;
