...
export {blur, blurFaces, pixelateFaces, grayscale, sepia, shadow, colorize, oilPaint};

export default {blur, blurFaces, pixelateFaces, grayscale, sepia, shadow, colorize, oilPaint};
